...
class AppFragment : BottomSheetDialogFragment() {
    ...
    private fun initView(view: View) {
        ...
        (appList.layoutParams as RelativeLayout.LayoutParams).bottomMargin = resources.getDimensionPixelOffset(R.dimen.expanded_offset)
        ...
        view.findViewById<TextView>(R.id.choose_text).visibility = View.VISIBLE
    }
